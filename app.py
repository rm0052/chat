...
if question:
    with st.spinner("Running..."):
        ...
        response = client.models.generate_content(model="gemini-2.0-thinking", contents=prompt)
        ...
        final_response = client.models.generate_content(model="gemini-2.0-thinking", contents=final_prompt)
